...
|program|usage|
|:---:|:---|
|caluc_electric_field|python directory直下で<br>python3 -m caluc_electric_field \<data directory path\> -dpi \<number\><br><br>**Example**:<br>python3 caluc_electric_field ./data/tmp_resolution200 -dpi 200|
|graph.py|python directory直下で<br>python3 ./graph.py \<data directory\> -option <br><br>**Example**:<br>python3 ./graph.py ./data/tmp -ef|
...
![github](https://img.shields.io/badge/-Github-000000.svg?logo=github&style=for-the-badgew)
